...
(function () {
    ...
    define(["lib/eventing"], function (eventing) {
        ...
        module.PROP_EVENT_TYPE_LIST_CHANGE = "property_list_change";
        module.PROP_EVENT_TYPE_LIST_DELETE_ITEM = "list_delete_item";
        module.PROP_EVENT_TYPE_LIST_UPDATE_ITEM_INDEX = "list_update_item_index";
        ...
        module.Property.prototype = {
            ...
            init: function (params) {
                ...
                if (!this.eventTypes) this.eventTypes = [module.PROP_EVENT_TYPE_CHANGE,
                                                         module.PROP_EVENT_TYPE_LIST_CHANGE,
                                                         module.PROP_EVENT_TYPE_LIST_DELETE_ITEM,
                                                         module.PROP_EVENT_TYPE_LIST_UPDATE_ITEM_INDEX];
            ...
            listenToObjects: function (index) {
                ...
                if (pathPart && pathPart.object) {
                    ...
                    if (module.isList(value)) {
                        ...
                        eventing.subscribeToMethodCall(this.targetList, 'push', this, this.attributeChanged);
                        eventing.subscribeToMethodCall(this.targetList, 'splice', this, this.attributeChanged);
                    }
                }
            ...
            unListenToObjects: function (index) {
                ...
                if (this.targetList) {
                    eventing.unSubscribeToMethodCall(this.targetList, 'push', this, this.attributeChanged);
                    eventing.unSubscribeToMethodCall(this.targetList, 'splice', this, this.attributeChanged);
                    this.targetList = null;
                }
            ...
            listenToObject: function (pathPart) {
                if (module.isList(pathPart.object)) {
                    ...
                    eventing.subscribeToMethodCall(pathPart.object, module.setterName(pathPart.propertyName), this, this.attributeChanged);
                }
            },
            ...
            unListenToObject: function (pathPart) {
                if (module.isList(pathPart.object)) {
                    ...
                    eventing.unSubscribe(pathPart.object, module.setterName(pathPart.propertyName), this, this.attributeChanged);
                }
            },
            ...
            isChanged: function (index, event) {
                ...
                case 'splice':
                    ...
                    var listIndex = parseInt(pathPart);
            ...
            raisePropertyChanged: function (type, originalEvent) {
                ...
                eventing.raiseEvent(this, 'propertyChanged', {
                    type: type,
                    value: this.value(),
                    orginalEvent: originalEvent
                });
            },
            ...
            attributeChanged: function (event) {
                ...
                if (event.sender === this.targetList) {
                    this.raisePropertyChanged(module.PROP_EVENT_TYPE_LIST_CHANGE, event);
                    return;
                }
            ...
            attributeChangedList: function (partIndex, event) {
                ...
                case 'splice':
                    ...
                    if (listIndex >= spliceIndex && listIndex < spliceIndex + spliceNumDel) {
                        ...
                        this.raisePropertyChanged(module.PROP_EVENT_TYPE_LIST_DELETE_ITEM, event);
                        return;
                    }
                    this.path = "!SEE_PATH_PARTS!";
                    var newIndex = listIndex - spliceNumDel + spliceNumAdd;
                    pathPart.propertyName = "" + newIndex;
                    this.raisePropertyChanged(module.PROP_EVENT_TYPE_LIST_UPDATE_ITEM_INDEX, event);
                    break;
                default:
        ...
        module.property = function (object, path) {
