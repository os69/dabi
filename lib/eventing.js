...
(function () {
    ...
    define([], function () {
        ...
        extend(module, {
            ...
            makeWeak: function (obj) {
                this.getEventProperties(obj).weak = true;
            },
            ...
            unSubscribe: function (sender, signal, receiver, handler) {
                ...
                // weak sender : delete all subscriptions if there are no more receivers
                if (this.getEventProperties(sender).weak && this.getEventProperties(sender).getAllReceivers().length === 0){
                    this.deleteSubscriptions(sender);
                    if(sender.deleteSubscriptionsCleanup) sender.deleteSubscriptionsCleanup();
                 }  
