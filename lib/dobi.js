    ...
    define(["eventing"], function (eventing) {
        ...
        module.Property.prototype = {
            ...
            resolve: function (path) {
                return module.makeProperty(this.value(), path);
            },
        ...
        module.bindList = function (property, node, transItem) {
            ...
            var bind = function (list) {
                ...
                for (var j = 0; j < list.length; j++) {
                    var element = list[j];
                    var elementProperty = module.makeListItemProperty(element, list);
                    transItem(elementProperty, node);
                }

                // event revceiver
                property.listEventTarget = {};
                ...
                eventing.subscribeToMethodCall(list, "splice", property.listEventTarget, function (event) {
                    ...
                    for (var i = 2; i < args.length; ++i) {
                        ...
                        var elementProperty = module.makeListItemProperty(listElement, list);
            ...
            if (property.path) property.subscribe(node, function () {
                module.unbindChildren(node);
                node.innerHTML = "";
                eventing.deleteSubscriptions(property.listEventTarget);
                bind(property.value());
            });
        ...
        module.bindDict = function (property, node, transItem) {
            ...
            var bind = function () {
                ...
                // bind list
                var listProperty = module.makeStaticProperty(list);
                ...
                var resolve = function (index, name, path) {
                    for (var i = index; i >= 0; --i) {
                        ...
                        if (!path) {
                            ...
                            property = module.makeProperty(property.value(), path);
